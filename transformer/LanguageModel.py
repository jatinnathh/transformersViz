...
class LanguageModel(nn.Module):
    ...
    def __init__(
        ...
        # FIX: apply weight init FIRST, then tie weights.
        # If you tie before applying, _init_weights reinitialises the embedding
        # and creates a new tensor — the LM head ends up pointing at the old
        # pre-init tensor that is no longer in the parameter tree, causing the
        # CUDA illegal memory access at loss computation.
